(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_02ce0673._.js", {
...
const CartProvider = ({ children })=>{
    _s();
    // Cart state
    const [cart, setCart] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(initialCart);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CartProvider.useEffect": ()=>{
            const newTotalPrice = cart.items.reduce({
                "CartProvider.useEffect.newTotalPrice": (total, item)=>total + item.price * item.quantity
            }["CartProvider.useEffect.newTotalPrice"], 0);
            setCart({
                "CartProvider.useEffect": (prevCart)=>({
                        ...prevCart,
    ...
    const addToCart = (item)=>{
        setCart((prevCart)=>{
            ...
            const existingItemIndex = prevCart.items.findIndex((i)=>i.type === item.type && i.swl === item.swl && i.length === item.length && i.color === item.color);
    ...
    const updateQuantity = (id, quantity)=>{
        ...
        setCart((prevCart)=>({
                ...prevCart,
                items: prevCart.items.map((item)=>item.id === id ? {
                        ...item,
                        quantity
                    } : item)
            }));
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(CartContext.Provider, {
        ...
        children: [
            children,
            notification.visible && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(CartProvider, "bWry2O1VSYdNdy2V8fiL/O36W1Y=");
_c = CartProvider;
const useCart = ()=>{
    _s1();
...
const Header = ()=>{
    _s();
    const { openCart, cart } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$CartContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCart"])();
...
_s(Header, "5KBnz27Uo0N0pfMuD65S5LM3jPM=", false, function() {
    return [
...
const CartSidebar = ()=>{
    _s();
    const { cart, isCartOpen, closeCart, removeFromCart, updateQuantity, clearCart, setCustomerInfo } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$CartContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCart"])();
    // State for customer information
    const [customerInfo, setCustomerFormInfo] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        name: '',
        phone: '',
        email: '',
        notes: ''
...
Ordered Items:
${cart.items.map((item)=>`- ${item.title} (${item.quantity} units)
   SWL: ${item.swl}, Length: ${item.length}
   Price: £${item.price.toFixed(2)} × ${item.quantity} = £${(item.price * item.quantity).toFixed(2)}`).join('\n\n')}
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                ...
                cart.items.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                ...
                                                formErrors.name && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                    className: "error",
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                    ...
                                                    children: orderStatus === 'loading' ? 'Sending...' : 'Send Order'
                                                }, void 0, false, {
                                                    fileName: "[project]/src/components/CartSidebar.tsx",
                                                    lineNumber: 276,
                                                    columnNumber: 21
                                        ...
                                        orderStatus === 'success' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            className: "success-message",
                                            children: "Order sent successfully! We will contact you soon."
                                        }, void 0, false, {
                                            fileName: "[project]/src/components/CartSidebar.tsx",
                                            lineNumber: 293,
                                            columnNumber: 21
                                        }, this),
                                        orderStatus === 'error' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            className: "error-message",
                                            children: "An error occurred when sending your order. Please try again or contact us directly."
                                        }, void 0, false, {
                                            fileName: "[project]/src/components/CartSidebar.tsx",
                                            lineNumber: 299,
                                            columnNumber: 21
...
_s(CartSidebar, "8PzLv8JhLlP3dDX5+v7CSEVtulg=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$CartContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCart"]
    ];
});
...
//# sourceMappingURL=src_02ce0673._.js.map